...
public class BinaryTree {
    ...
    public int countLeaves (BinaryTree t){
        ...
        return countLeaves(t.getRightSubTree())+countLeaves(t.getRightSubTree());
    }
    public int iPathLength(BinaryTree t, int height){
        if (t==null){
            return 0;
        }
        return height+iPathLength(t.getRightSubTree(),height+1)+iPathLength(t.getRightSubTree(),height+1);
    ...
    public int countNodes(BinaryTree t){
        ...
        return 1+countNodes(t.getRightSubTree())+countNodes(t.getLeftSubTree());
    }
    ...
    public boolean isEqual(BinaryTree t1, BinaryTree t2){
        ...
        return (t1.getTreeValue()==t2.getTreeValue())
                &&(isEqual(t1.getLeftSubTree(),t2.getRightSubTree()))
